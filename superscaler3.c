...
int main(int argc, char ** argv) {
  ...
  struct instruction *tr_entry, *tr_entry2, *tr_entryA, *tr_entryL;

  struct instruction PCregister, PCregister_B, IF_ID_A, IF_ID_B, ID_EX1, ID_EX2, EX_MEM1, EX_MEM2, MEM_WB1, MEM_WB2, lastAlu, lastLw, aluOp, lwOp, EMPTY_INST;
